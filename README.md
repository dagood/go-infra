...
To build Go from source or download a binary release, visit https://golang.org/dl/.
This repository is not involved in the official Go distribution.

Visit the [docs](docs) directory for more information about the infrastructure implemented in this repository.
